...
public class PolygonSorterForName
{
	...
	/**
	 * Default constructor accept input from command line.
	 * The argument has 3 input parameter that can be inputed in different ordering.
	 * 
	 * @param arg1 the filename or compareType or sortType
	 * @param arg2 the filename or compareType or sortType
	 * @param arg3 the filename or compareType or sortType
	 */
	...
	/**
	 * Read in the shape name, height and length then construct a object based on the name
	 */
...
//				polygonArray = polys.toArray(Polygon[] polygonArray);
	...
	/**
	 * Check which sort type the user entered and use correct sorting.
	 */
	public void sortPolygons()
	{
		...
		if(sortType == 'p')
		{
			Sorts.pancakeSort(polygonArray, polygonArray.length);
		}
		
		//*******************    NOT REQUIRED     ******************//
		//if(sortType == 'g')										//
		//{															//
		//	Sorts.gnomeSort(polygonArray, polygonArray.length);		//
		//}															//
		//if(sortType == 'c')										//
		//{															//
		//	Sorts.cycleSort(polygonArray, polygonArray.length);		//
		//}															//
		//**********************************************************//
